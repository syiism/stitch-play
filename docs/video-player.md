...
>
> **注意（v1.2 起）**：本文档 v1.0 描述的五状态模型（含独立"缝合态 StitchContext"）已被 `refactor/merge-stitch` 分支重构取代——缝合态现已**融入合集队列**（`exited` 标记），状态数 5→4。当前实现以 [video-player-v1.2.md](./video-player-v1.2.md) 为准；本文保留作为历史起点与 ADR-1~7 的依据。
